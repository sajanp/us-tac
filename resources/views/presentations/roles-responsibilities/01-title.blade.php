<div class="relative min-h-screen overflow-hidden" style="background: #080c14;">
    ...
    <canvas id="rr01-particles" class="absolute inset-0 w-full h-full pointer-events-none"></canvas>

    {{-- Content --}}
    <div class="relative z-10 min-h-screen flex flex-col" style="padding: 56px 72px;">

        {{-- Top bar --}}
        <div class="rr01-s1 flex items-center justify-between">
        ...
        <div class="flex-1 flex flex-col items-center justify-center">
            ...
            <div class="rr01-s2 mb-8">
                <div class="inline-flex items-center gap-3 px-6 py-2.5 rounded-full" style="border: 1px solid rgba(17,193,143,0.12); background: rgba(17,193,143,0.03);">
                    ...
                    <span style="text-transform: uppercase; letter-spacing: 0.35em; color: rgba(17,193,143,0.8); font-size: 11px; font-weight: 600; font-family: 'Sora', sans-serif;">Team Alignment Session</span>
                    <div class="w-1 h-1 rounded-full" style="background: #11C18F; box-shadow: 0 0 6px #11C18F;"></div>
                </div>
            </div>

            {{-- Title --}}
            <div class="rr01-s3 mb-6">
                <h1 class="rr01-title text-center leading-[0.95]">
                    <span class="block" style="color: rgba(255,255,255,0.92);">Roles, Responsibilities</span>
                    <span class="block rr01-amp">&amp; Expectations</span>
                </h1>
            </div>

            {{-- Decorative divider --}}
            <div class="rr01-s4 mb-10">
            ...
            {{-- Subtitle --}}
            <div class="rr01-s5">
                <p style="font-family: 'Sora', sans-serif; font-size: 1.1rem; color: rgba(255,255,255,0.3); letter-spacing: 0.01em; text-align: center; max-width: 480px; line-height: 1.7;">
                    Defining clear ownership across our products so the right people make the right decisions.
                </p>
            </div>
        </div>

        {{-- Bottom bar --}}
        <div class="rr01-s6 flex items-center justify-between">
            <div></div>
...
<style>
    ...
    .rr01-amp {
        ...
        animation: rr01-shimmer 5s ease-in-out infinite;
        position: relative;
    }
    ...
    @keyframes rr01-reveal-down {
        from { opacity: 0; transform: translateY(-15px); }
        to { opacity: 1; transform: translateY(0); }
    }

    .rr01-s1 { opacity: 0; animation: rr01-reveal-down 0.8s ease-out 0.1s forwards; }
    .rr01-s2 { opacity: 0; animation: rr01-reveal 0.9s cubic-bezier(0.22, 1, 0.36, 1) 0.3s forwards; }
    .rr01-s3 { opacity: 0; animation: rr01-reveal 0.9s cubic-bezier(0.22, 1, 0.36, 1) 0.5s forwards; }
    .rr01-s4 { opacity: 0; animation: rr01-reveal 0.9s cubic-bezier(0.22, 1, 0.36, 1) 0.8s forwards; }
    .rr01-s5 { opacity: 0; animation: rr01-reveal 0.9s cubic-bezier(0.22, 1, 0.36, 1) 1.0s forwards; }
    .rr01-s6 { opacity: 0; animation: rr01-reveal 0.9s cubic-bezier(0.22, 1, 0.36, 1) 1.4s forwards; }
</style>

<script>
    document.addEventListener('DOMContentLoaded', function() {
        var canvas = document.getElementById('rr01-particles');
        if (!canvas) return;
